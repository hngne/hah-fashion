...
namespace QA_TMDT.Repository
{
    ...
    {
        Task<(List<SanPham> data, int totalItem)> GetAllSP(int page, int pageSize);
        ...
        Task<(List<SanPham>? data, int totalItem)> GetByMaDM(int maDM, int page, int pageSize);
        Task<(List<SanPham>? data, int totalItem)> GetByTenSP(string tenSP, int page, int pageSize);
