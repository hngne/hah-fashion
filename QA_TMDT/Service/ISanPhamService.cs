...
namespace QA_TMDT.Service
{
    public interface ISanPhamService
    {
        ...
        Task<PageResult<SanPhamResponse>> GetByMaDM(int maDM, int page, int pageSize, decimal? minPrice = null, decimal? maxPrice = null, int? maKichThuoc = null, int? maMauSac = null);
        Task<PageResult<SanPhamResponse>> GetByTenSP(string tenSP, int page, int pageSize, decimal? minPrice = null, decimal? maxPrice = null, int? maKichThuoc = null, int? maMauSac = null);
